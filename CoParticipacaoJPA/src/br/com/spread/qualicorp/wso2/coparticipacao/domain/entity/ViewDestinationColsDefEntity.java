...
@NamedQuery(name = "ViewDestinationColsDefEntity.findAll", query = "SELECT v FROM ViewDestinationColsDefEntity v")
public class ViewDestinationColsDefEntity extends ViewDestinationColsDef implements DomainEntity {
