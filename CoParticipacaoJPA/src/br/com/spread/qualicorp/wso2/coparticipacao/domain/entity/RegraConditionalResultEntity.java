...
@NamedQuery(
		name = "RegraConditionalResultEntity.findAll",
		query = "SELECT r FROM RegraConditionalResultEntity r")
public class RegraConditionalResultEntity extends RegraConditionalResult {
