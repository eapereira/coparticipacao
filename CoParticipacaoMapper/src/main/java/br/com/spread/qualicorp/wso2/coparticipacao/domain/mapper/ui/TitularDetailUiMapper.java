...
@Mapper(
		...
		uses = { UserUiMapper.class, TitularUiMapper.class, ArquivoInputColsDefUiMapper.class })
public abstract class TitularDetailUiMapper extends AbstractMapper<TitularDetail, TitularDetailUi> {
