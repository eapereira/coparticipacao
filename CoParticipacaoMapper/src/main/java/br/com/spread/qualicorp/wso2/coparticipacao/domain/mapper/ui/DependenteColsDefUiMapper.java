...
@Mapper(
		...
		uses = { UserUiMapper.class, InputDependenteUiMapper.class })
public abstract class DependenteColsDefUiMapper
		extends AbstractMapper<DependenteColsDef, DependenteColsDefUi> {
