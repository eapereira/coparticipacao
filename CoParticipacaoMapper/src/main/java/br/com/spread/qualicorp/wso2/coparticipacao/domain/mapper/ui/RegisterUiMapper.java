...
@Mapper(
		...
		uses = { UserUiMapper.class, RegisterColumnUiMapper.class, ArquivoInputSheetUiMapper.class })
public abstract class RegisterUiMapper extends AbstractMapper<Register, RegisterUi> {
