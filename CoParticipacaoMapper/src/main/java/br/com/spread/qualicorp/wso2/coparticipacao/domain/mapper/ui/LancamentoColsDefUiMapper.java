...
@Mapper(
		...
		uses = { UserUiMapper.class, InputLancamentoUiMapper.class })
public abstract class LancamentoColsDefUiMapper
		extends AbstractMapper<LancamentoColsDef, LancamentoColsDefUi> {
