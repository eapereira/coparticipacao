...
@Mapper(
		...
		uses = { UserUiMapper.class, ArquivoInputUiMapper.class, LancamentoInputColsUiMapper.class })
public abstract class LancamentoInputUiMapper extends AbstractMapper<LancamentoInput, LancamentoInputUi> {
