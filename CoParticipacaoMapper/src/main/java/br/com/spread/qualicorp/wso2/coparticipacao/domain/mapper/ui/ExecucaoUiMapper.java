 ...
 *
 */
@Mapper(componentModel = "spring", uses = { UserUiMapper.class, ArquivoExecucaoUiMapper.class, EmpresaUiMapper.class })
public abstract class ExecucaoUiMapper extends AbstractMapper<Execucao, ExecucaoUi> {
