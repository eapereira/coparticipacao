 ...
 *
 */
public class ArquivoOutputSheetColsDefSetter extends
		PreparedStatementSetterAdapter<ArquivoOutputSheetColsDefEntity> {

	private static final int COL_ID_VIEW_DESTINATION_COLS_DEF = 1;
