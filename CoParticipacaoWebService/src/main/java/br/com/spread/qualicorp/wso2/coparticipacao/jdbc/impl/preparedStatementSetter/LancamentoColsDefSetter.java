 ...
 *
 */
public class LancamentoColsDefSetter extends PreparedStatementSetterAdapter<LancamentoColsDefEntity> {
	...
	public LancamentoColsDefSetter(SetterAdapterType setterAdapterType, LancamentoColsDefEntity entity) {
