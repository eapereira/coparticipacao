 ...
 *
 */
public class InputLancamentoSetter extends PreparedStatementSetterAdapter<InputLancamentoEntity> {

	private static final int COL_ID_LANCAMENTO_COLS_DEF = 1;
	...
	public InputLancamentoSetter(SetterAdapterType setterAdapterType, InputLancamentoEntity entity) {
	...
	protected void setValuesForInsert(PreparedStatement ps) throws SQLException {
		ps.setLong(COL_ID_LANCAMENTO_COLS_DEF, getEntity().getLancamentoColsDef().getId());
