...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default 'dml-20180724-002-marjan-8C5Z8.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default 'dml-20180724-003-marjan-8C5Z9.sql';
	...
	declare VAR_ID_COLUMN_08_8C5Z9						bigint( 17 );
	declare VAR_ID_COLUMN_09_8C5Z9_CPF					bigint( 17 );
	declare VAR_ID_COLUMN_10_8C5Z9_MES					bigint( 17 );
	declare VAR_ID_COLUMN_11_8C5Z9						bigint( 17 );
	declare VAR_ID_COLUMN_12_8C5Z9_ANO					bigint( 17 );
	declare VAR_ID_COLUMN_13_8C5Z9_POSITIVO_NEGATIVO	bigint( 17 );
	declare VAR_ID_COLUMN_14_8C5Z9_VL_PRINCIPAL			bigint( 17 );
	declare VAR_ID_COLUMN_15_8C5Z9_CONTRATO				bigint( 17 );
	declare VAR_ID_COLUMN_16_8C5Z9_DT_NASCIMENTO		bigint( 17 );
	declare VAR_ID_COLUMN_17_8C5Z9						bigint( 17 );
	declare VAR_ID_COLUMN_18_8C5Z9_NM_TITULAR			bigint( 17 );
	declare VAR_ID_COLUMN_19_8C5Z9_NR_MATRICULA			bigint( 17 );
	declare VAR_ID_COLUMN_20_8C5Z9						bigint( 17 );
	...
	select ID into VAR_ID_CONTRATO_FATUCOPA_8C5Z9 from TB_CONTRATO
	where CD_CONTRATO = '8C5Z9'; 
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_CREATED,
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO_FATUCOPA_8C5Z9,
	...
	select max( ID ) into VAR_ID_COLUMN_08_8C5Z9 from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_09_8C5Z9_CPF from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_10_8C5Z9_MES from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_11_8C5Z9 from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_12_8C5Z9_ANO from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_13_8C5Z9_POSITIVO_NEGATIVO from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_14_8C5Z9_VL_PRINCIPAL from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_15_8C5Z9_CONTRATO from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_16_8C5Z9_DT_NASCIMENTO from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_17_8C5Z9 from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_18_8C5Z9_NM_TITULAR from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_19_8C5Z9_NR_MATRICULA from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_20_8C5Z9 from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	insert into TB_LANCAMENTO_INPUT_COLS (
		...
		VAR_ID_COLUMN_15_8C5Z9_CONTRATO,
	...
	insert into TB_LANCAMENTO_INPUT_COLS (
		...
		VAR_ID_COLUMN_14_8C5Z9_VL_PRINCIPAL,
	...
	insert into TB_REGRA(
		...
		DT_CREATED,
		DT_ALTERED ) values (
		'MARJAN.8C5Z9 - Regra para Valor do Arquivo FATUCOPA MARJAN dividido por 100',
		1, /* SIMPLES */
		0,
		VAR_ID_ARQUIVO_INPUT,
	...
	insert into TB_REGRA(
		...
		DT_CREATED,
		DT_ALTERED ) values (
		'MARJAN.8C5Z9 - Regra para multiplicar o VL_PRINCIPAL por ( -1 ) se o valor da coluna COLUMN_13_POSITIVO_NEGATIVO for igual a ( - )',
		2, /* CONDICIONAL */
		0,
		VAR_ID_ARQUIVO_INPUT,
	...
	insert into TB_REGRA_CONDITIONAL(
		...
		DT_CREATED,
		DT_ALTERED ) values (
		'MARJAN.8C5Z9 - Regra para mudar o sinal do campo VL_PRINCIPAL dependendo do valor (+/-) do campo VL_NEGATIVO_POSITIVO',
		0,
		VAR_ID_ARQUIVO_INPUT,
	...
	insert into TB_REGRA_CONDITIONAL_FIELD(
		...
		VAR_ID_COLUMN_13_8C5Z9_POSITIVO_NEGATIVO,
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		VAR_ID_COLUMN_19_8C5Z9_NR_MATRICULA,
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		VAR_ID_COLUMN_07_8C5Z9_NM_BENEFICIARIO,
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		VAR_ID_COLUMN_16_8C5Z9_DT_NASCIMENTO,
