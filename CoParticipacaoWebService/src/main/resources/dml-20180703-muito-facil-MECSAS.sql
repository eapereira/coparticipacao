...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default 'dml-20180703-muito-facil-8CHE8.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default 'dml-20180703-muito-facil-MECSAS.sql';
