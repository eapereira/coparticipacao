...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default 'dml-20180726-005-marjan-8C7XY.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default 'dml-20180726-006-marjan-ISENTOS.sql';
	...
	where NM_CONTRATO = 'ISENTOS Marjan'; 
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO,
		'^(Isentos)\\WSulAmérica\\W([0-9]{2})([0-9]{4})\\.(xlsx|XLSX)$',
