...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default 'dml-20180724-001-marjan.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default 'dml-20180724-002-marjan-8C5Z8.sql';
	...
	select ID into VAR_ID_CONTRATO_FATUCOPA_8C5Z8 from TB_CONTRATO
	where CD_CONTRATO = '8C5Z8';  
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_CREATED,
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO_FATUCOPA_8C5Z8,
	...
	select max( ID ) into VAR_ID_COLUMN_08_8C5Z8 from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_09_8C5Z8_CPF from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_10_8C5Z8_MES from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_11_8C5Z8 from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_12_8C5Z8_ANO from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_13_8C5Z8_POSITIVO_NEGATIVO from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_14_8C5Z8_VL_PRINCIPAL from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_15_8C5Z8_CONTRATO from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_16_8C5Z8_DT_NASCIMENTO from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_17_8C5Z8 from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_18_8C5Z8_NM_TITULAR from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_19_8C5Z8_NR_MATRICULA from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_20_8C5Z8 from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	insert into TB_LANCAMENTO_INPUT_COLS (
		...
		VAR_ID_COLUMN_15_8C5Z8_CONTRATO,
	...
	insert into TB_LANCAMENTO_INPUT_COLS (
		...
		VAR_ID_COLUMN_14_8C5Z8_VL_PRINCIPAL,
	...
	insert into TB_REGRA_CONDITIONAL_FIELD(
		...
		VAR_ID_COLUMN_13_8C5Z8_POSITIVO_NEGATIVO,
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		VAR_ID_COLUMN_19_8C5Z8_NR_MATRICULA,
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		VAR_ID_COLUMN_07_8C5Z8_NM_BENEFICIARIO,
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		VAR_ID_COLUMN_16_8C5Z8_DT_NASCIMENTO,
