...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default 'dml-20180806-003-abbvie-ISENTOS.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default 'dml-20180806-004-abbvie-MECSAS.sql';
	...
	where NM_CONTRATO = 'MECSAS Abbvie';
