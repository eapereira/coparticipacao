...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default 'dml-20180810-004-HOC-ISENTOS.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default 'dml-20180815-005-HOC-NAO-LOCALIZADOS.sql';
	...
	where CD_CONTRATO = 'naoLocalizados.HOC';
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO,
		'^NAO\-LOCALIZADO\-HOC\-([0-9]{4})([0-9]{2})\.(xlsx|XLSX)$',
