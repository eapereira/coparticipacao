...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default 'dml-20180806-005-abbvie-MECSAS2.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default 'dml-20180808-006-abbvie-NAO-LOCALIZADOS.sql';
	...
	where CD_CONTRATO = 'MECSAS2.abbvie.naoLocalizados';
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO,
		'^NAO\-LOCALIZADO\-ABBVIE\-([0-9]{4})([0-9]{2})\.(xlsx|XLSX)$',
