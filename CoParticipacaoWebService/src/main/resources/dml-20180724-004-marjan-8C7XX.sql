...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default 'dml-20180724-003-marjan-8C5Z9.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default 'dml-20180724-004-marjan-8C7XX.sql';
	...
	declare VAR_ID_COLUMN_01_8C7XX						bigint( 17 );
	declare VAR_ID_COLUMN_02_8C7XX						bigint( 17 );
	declare VAR_ID_COLUMN_03_8C7XX						bigint( 17 );
	declare VAR_ID_COLUMN_04_8C7XX						bigint( 17 );
	declare VAR_ID_COLUMN_05_8C7XX						bigint( 17 );
	declare VAR_ID_COLUMN_06_8C7XX						bigint( 17 );
	declare VAR_ID_COLUMN_07_8C7XX_NM_BENEFICIARIO		bigint( 17 );
	declare VAR_ID_COLUMN_08_8C7XX						bigint( 17 );
	declare VAR_ID_COLUMN_09_8C7XX_CPF					bigint( 17 );
	declare VAR_ID_COLUMN_10_8C7XX_MES					bigint( 17 );
	declare VAR_ID_COLUMN_11_8C7XX						bigint( 17 );
	declare VAR_ID_COLUMN_12_8C7XX_ANO					bigint( 17 );
	declare VAR_ID_COLUMN_13_8C7XX_POSITIVO_NEGATIVO	bigint( 17 );
	declare VAR_ID_COLUMN_14_8C7XX_VL_PRINCIPAL			bigint( 17 );
	declare VAR_ID_COLUMN_15_8C7XX_CONTRATO				bigint( 17 );
	declare VAR_ID_COLUMN_16_8C7XX_DT_NASCIMENTO		bigint( 17 );
	declare VAR_ID_COLUMN_17_8C7XX						bigint( 17 );
	declare VAR_ID_COLUMN_18_8C7XX_NM_TITULAR			bigint( 17 );
	declare VAR_ID_COLUMN_19_8C7XX_NR_MATRICULA			bigint( 17 );
	declare VAR_ID_COLUMN_20_8C7XX						bigint( 17 );
	...
	select ID into VAR_ID_CONTRATO_FATUCOPA_8C7XX from TB_CONTRATO
	where CD_CONTRATO = '8C7XX'; 
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_CREATED,
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO_FATUCOPA_8C7XX,
		'^(8C7XX)(FATUCOPA)\\.([0-9]{4})([0-9]{2})([0-9]{3})F\\.(txt|TXT)$',
	...
	select max( ID ) into VAR_ID_COLUMN_01_8C7XX from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_02_8C7XX from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_03_8C7XX from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_04_8C7XX from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_05_8C7XX from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_06_8C7XX from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_07_8C7XX_NM_BENEFICIARIO from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_08_8C7XX from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_09_8C7XX_CPF from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_10_8C7XX_MES from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_11_8C7XX from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_12_8C7XX_ANO from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_13_8C7XX_POSITIVO_NEGATIVO from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_14_8C7XX_VL_PRINCIPAL from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_15_8C7XX_CONTRATO from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_16_8C7XX_DT_NASCIMENTO from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_17_8C7XX from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_18_8C7XX_NM_TITULAR from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_19_8C7XX_NR_MATRICULA from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_20_8C7XX from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	insert into TB_LANCAMENTO_INPUT_COLS (
		...
		VAR_ID_COLUMN_15_8C7XX_CONTRATO,
	...
	insert into TB_LANCAMENTO_INPUT_COLS (
		...
		VAR_ID_COLUMN_14_8C7XX_VL_PRINCIPAL,
	...
	insert into TB_REGRA(
		...
		DT_CREATED,
		DT_ALTERED ) values (
		'MARJAN.8C7XX - Regra para Valor do Arquivo FATUCOPA MARJAN dividido por 100',
		1, /* SIMPLES */
		0,
		VAR_ID_ARQUIVO_INPUT,
	...
	insert into TB_REGRA(
		...
		DT_CREATED,
		DT_ALTERED ) values (
		'MARJAN.8C7XX - Regra para multiplicar o VL_PRINCIPAL por ( -1 ) se o valor da coluna COLUMN_13_POSITIVO_NEGATIVO for igual a ( - )',
		2, /* CONDICIONAL */
		0,
		VAR_ID_ARQUIVO_INPUT,
	...
	insert into TB_REGRA_CONDITIONAL(
		...
		DT_CREATED,
		DT_ALTERED ) values (
		'MARJAN.8C7XX - Regra para mudar o sinal do campo VL_PRINCIPAL dependendo do valor (+/-) do campo VL_NEGATIVO_POSITIVO',
		0,
		VAR_ID_ARQUIVO_INPUT,
	...
	insert into TB_REGRA_CONDITIONAL_FIELD(
		...
		VAR_ID_COLUMN_13_8C7XX_POSITIVO_NEGATIVO,
    ...
    call PROC_LOG_MESSAGE('LINHA - 1856');
	insert into TB_BENEFICIARIO_COLS(
		...
		VAR_ID_COLUMN_19_8C7XX_NR_MATRICULA,
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		VAR_ID_COLUMN_07_8C7XX_NM_BENEFICIARIO,
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		VAR_ID_COLUMN_16_8C7XX_DT_NASCIMENTO,
