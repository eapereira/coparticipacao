...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default 'dml-20180805-001-abbvie.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default 'dml-20180805-002-abbvie-8B1LR.sql';
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO,
		'^(8B1LR)FATUCOPA\\.([0-9]{4})([0-9]{2})([0-9]{3})F\\.(txt|TXT)$',
