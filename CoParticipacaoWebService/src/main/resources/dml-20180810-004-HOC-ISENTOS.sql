...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default 'dml-20180810-003-HOC-MECSAS.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default 'dml-20180810-004-HOC-ISENTOS.sql';
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO,
		'^(ISENTO\\-HOC)\\-([0-9]{4})([0-9]{2})([0-9]{2})\\.(xlsx)$',
