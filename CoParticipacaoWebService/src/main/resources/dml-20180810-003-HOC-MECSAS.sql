...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default 'dml-20180810-002-HOC-0444.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default 'dml-20180810-003-HOC-MECSAS.sql';
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO,
		'^(MECSAS\\-HOC)\\-([0-9]{4})([0-9]{2})([0-9]{2})\\.(csv|CSV)$',
	...
	call PROC_LOG_MESSAGE('LINHA - 2262');
	/*********************************************************************************************************************************************/
	/*********************************************************************************************************************************************/	
