...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default 'dml-20180726-006-marjan-ISENTOS.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default 'dml-20180730-007-marjan-MECSAS.sql';
	...
	where NM_CONTRATO = 'MECSAS Marjan'; 
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO,
		'^(MARJAN INDUSTRIA E COMERCIO LTDA)\\_(MECSAS)\\-(1781)-([0-9]{4})([0-9]{2})([0-9]{2})\\-(152849)\\.(CSV|csv)$',
