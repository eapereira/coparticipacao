...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default 'dml-20180810-001-HOC.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default 'dml-20180810-002-HOC-0444.sql';
	...
	where CD_CONTRATO = 'FATUCOPA-HOC'; 
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO,
		'^(FATUCOPA\\-HOC)\\-([0-9]{4})([0-9]{2})([0-9]{2})\\.(csv|CSV)$',
