...
public class OswaldoCruzTest extends CoParticipacaoTest {
	...
	public void testCoparticipacao201902() throws Exception {
		...
		hocBean.testCoparticipacao201902(this);

		LOGGER.info("END");
	}

	@Test
	public void testCoparticipacao201902AfterUserValidation() throws Exception {
		LOGGER.info("BEGIN");

		hocBean.testCoparticipacao201902AfterUserValidation(this);
