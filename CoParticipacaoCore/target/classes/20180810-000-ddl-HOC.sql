...
where ID_ARQUIVO_INPUT_COLS_DEF = (
	...
	from TB_ARQUIVO_INPUT_COLS_DEF cols_def
		...
		join TB_CONTRATO contrato on
			contrato.ID 			= arquivo_input.ID_CONTRATO and
			contrato.CD_CONTRATO	= 'MECSAS'
		join TB_EMPRESA empresa on
			empresa.ID 				= contrato.ID_EMPRESA and
			empresa.CD_EMPRESA 		= '0444'
	where 	cols_def.NM_COLUMN 		= 'COLUMN_05_RDP' );
...
select 
	...
	dependente.NR_REF_CODE NR_LOCAL
