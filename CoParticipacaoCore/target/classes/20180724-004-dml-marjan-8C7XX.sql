...
BEGIN
	...
	select ID into VAR_ID_CONTRATO_FATUCOPA from TB_CONTRATO
	...
	select max( ID ) into VAR_ID_COLUMN_09_CPF from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_10_MES from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_12_ANO from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_15_CONTRATO from TB_ARQUIVO_INPUT_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_18_NM_TITULAR from TB_ARQUIVO_INPUT_COLS_DEF; 
