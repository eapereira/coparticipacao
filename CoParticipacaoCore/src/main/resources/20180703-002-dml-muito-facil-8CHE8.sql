...
BEGIN
    ...
    */
    ...
    select max( ID ) into VAR_ID_COLUMN_10_CD_MES from TB_REGISTER_COLUMN;
    ...
    select max( ID ) into VAR_ID_COLUMN_12_CD_ANO from TB_REGISTER_COLUMN;
    ...
    select max( ID ) into VAR_ID_COLUMN_15_CD_CONTRATO from TB_REGISTER_COLUMN;
    ...
    select max( ID ) into VAR_ID_COLUMN_18 from TB_REGISTER_COLUMN;
    ...
    select max( ID ) into VAR_ID_COLUMN_19 from TB_REGISTER_COLUMN;
    ...
    select max( ID ) into VAR_ID_COLUMN_20_DT_MOVTO from TB_REGISTER_COLUMN;
    ...
    select max( ID ) into VAR_ID_COLUMN_21_NM_TITULAR from TB_REGISTER_COLUMN;
    ...
    select max( ID ) into VAR_ID_COLUMN_22_NR_MATRICULA from TB_REGISTER_COLUMN;
    ...
    select max( ID ) into VAR_ID_COLUMN_23 from TB_REGISTER_COLUMN;
    ...
    call PROC_LOG_MESSAGE('LINHA - 874');
    insert into TB_LANCAMENTO_INPUT_SHEET_COLS (
        ID_LANCAMENTO_INPUT_SHEET,
        ID_REGISTER_COLUMN,
        CD_LANCAMENTO_COLS_DEF,
    ...
    call PROC_LOG_MESSAGE('LINHA - 892');
    insert into TB_LANCAMENTO_INPUT_SHEET_COLS (
        ID_LANCAMENTO_INPUT_SHEET,
        ID_REGISTER_COLUMN,
        CD_LANCAMENTO_COLS_DEF,
    ...
    call PROC_LOG_MESSAGE('LINHA - 928');
    insert into TB_LANCAMENTO_INPUT_SHEET_COLS (
        ID_LANCAMENTO_INPUT_SHEET,
        ID_REGISTER_COLUMN,
        CD_LANCAMENTO_COLS_DEF,
	...
	call PROC_LOG_MESSAGE('LINHA - 966');    
    /*****************************************************************************************************************************************************/
    /*****************************************************************************************************************************************************/
    /* Regra */

    call PROC_LOG_MESSAGE('LINHA - 951');
