...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20181201-006-dml-SPREAD-SAUDE-NAO-LOCALIZADO.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181201-007-dml-SPREAD-SAUDE-ISENTO.sql';
	...
	declare VAR_ID_COLUMN_001_NM_EMPRESA 				bigint( 17 );
	...
	declare VAR_CD_ISENTO_COLS_DEF_CD_PLANO								bigint( 17 ) default 13;
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO,
		'^(073828)\\.(ISENTO)\\.([0-9]{4})([0-9]{2})\\.([0-9]{3})\\.(xlsx|XLSX)$',
	...
	insert into TB_ISENTO_INPUT_SHEET_COLS(
		...
		VAR_CD_ISENTO_COLS_DEF_CD_PLANO,
