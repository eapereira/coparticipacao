...
BEGIN
	...
	declare VAR_NR_MATRICULA_BASE											bigint( 17 ) default 985960000000000;
	...
	insert into TB_ARQUIVO_OUTPUT(
		...
		DT_ALTERED ) values (
		VAR_ID_ARQUIVO_INPUT,
		'Techint({CC})-Bradesco (Saude) - Coparticipação_({YYYY}{MM}).xlsx',
	...
	insert into TB_ARQUIVO_OUTPUT_DESCONHECIDO(
		...
		DT_ALTERED ) values (
		VAR_ID_ARQUIVO_INPUT,
		'NAO-LOCALIZADO-TECHINT-SAUDE-{YYYY}{MM}.xlsx',
