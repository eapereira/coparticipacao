...
BEGIN
	...
	select max( ID ) into VAR_ID_COLUMN_01_CD_CONTRATO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_03_DV from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_04_RDP from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_05_DC from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_06_LOCAL from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_07_CAT_FUNCIONAL from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_08_SETOR from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_09_ESTADO_CIVIL from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_10_CD_PLANO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_11_CD_PLANO_AGREG from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_12_DT_INCLUSAO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_13_CD_PLANO_COMPL from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_14_NR_CPF from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_15_DG_CPF from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_18_DG_AGENCIA from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_25_GP from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_30_DT_REF from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_31_CD_ORGAO_LOTACAO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_38_NUMERO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_51_CD_ORGAO_EMISSOR from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_54_UF_EMISSAO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_55_NR_PIS from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_56_NR_CNS from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_62_CD_IDENTIFICACAO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_63_CD_OPERACAO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_64_CRITICAS_01 from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_65_CRITICAS_02 from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_66_CRITICAS_03 from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_67_CRITICAS_04 from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_68_CRITICAS_05 from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_69_CRITICAS_06 from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_70_CRITICAS_07 from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_71_CRITICAS_08 from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_72_CRITICAS_09 from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	...
	select max( ID ) into VAR_ID_COLUMN_73_CRITICAS_10 from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
