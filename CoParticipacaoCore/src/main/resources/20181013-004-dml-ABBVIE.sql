...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20181013-003-dml-MARJAN.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181013-004-dml-ABBVIE.sql';
	...
	select	ID into VAR_ID_COLUMN_17_DT_NASCIMENTO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where 	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN			= 'COLUMN_17_DT_NASCIMENTO';
