...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20180919-004-dml-CARGILL-00192.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20180920-001-dml-CARGILL-00196.sql';
	...
	declare VAR_NR_MATRICULA_BASE										bigint( 17 ) default 19600000000000;
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO,
		'^(CARGILL)\\.(00196)\\.([0-9]{4})([0-9]{2})\\.([0-9]{3})\\.(csv|CSV)$',
	...
	/*****************************************************************************************************************************************************/
	call PROC_LOG_MESSAGE('LINHA - 241');
	...
	insert into TB_REGRA(
		...
		DT_CREATED,
		DT_ALTERED ) values (
		'CARGIL.00196.TITULAR',
		'Regra para subtrair o NR_MATRICULA_TITULAR do beneficiário por 19600000000000',
	...
	/*********************************************************************************************************************************************/
	call PROC_LOG_MESSAGE('LINHA - 930');
	insert into TB_REGRA(
		NM_REGRA,
		DESCR_REGRA,
		TP_REGRA,
