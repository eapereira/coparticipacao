...
BEGIN
	...
	declare VAR_COLUMN_02_NM_DEPENDENTE				bigint( 17 );
	...
	select max( ID ) into VAR_COLUMN_02_NM_DEPENDENTE 
	...
	select max( ID ) into VAR_COLUMN_04_NR_CPF
	from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_COLUMN_05_DT_ADMISSAO 
	from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_COLUMN_06_NR_UPI 
	from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
