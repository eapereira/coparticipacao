...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20180724-001-dml-marjan.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20180724-002-dml-marjan-8C5Z8.sql';
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO,
		'^(MARJAN)\\.(8C5Z8)\\.([0-9]{4})([0-9]{2})\\.([0-9]{3})\\.(txt|TXT)$',
