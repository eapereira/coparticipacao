...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20181201-002-dml-SPREAD-SAUDE.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181201-003-dml-SPREAD-SAUDE-MECSAS.sql';
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO,
		'^(073828)\\.(MECSAS)\\.([0-9]{4})([0-9]{2})\\.([0-9]{3})\\.(xlsx|XLSX)$',
	...
	call PROC_LOG_MESSAGE('LINHA - 420');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 1031');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 1057');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 1083');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 1109');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 1135');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 1189');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 1215');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 1241');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 1295');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 1321');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 1349');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 1377');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 1431');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 1459');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 1537');
	/*********************************************************************************************************************************************/
	/*********************************************************************************************************************************************/	
