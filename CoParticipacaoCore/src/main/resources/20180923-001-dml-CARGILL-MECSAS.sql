...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20180921-003-dml-HOC.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20180923-001-dml-CARGILL-MECSAS.sql';
	...
	select	ID into VAR_ID_COLUMN_001_NUM_LINHA 
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_001_NUM_LINHA';
	...
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_003_NR_MATRICULA
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_003_NR_MATRICULA';
	
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_004_DF
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_004_DF';
	
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_005_RDP
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_005_RDP';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_006_NR_LOCAL
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_006_NR_LOCAL';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_007_CD_CATEGORIA
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_007_CD_CATEGORIA';
	
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_008_SETOR
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_008_SETOR';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_009_ES
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_009_ES';
	...
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_011_DT_ADESAO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_011_DT_ADESAO';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_012_NR_CPF
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_012_NR_CPF';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_013_NM_BENEFICIARIO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_013_NM_BENEFICIARIO';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_014_DT_NASCIMENTO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_014_DT_NASCIMENTO';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_015_SEXO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_015_SEXO';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_016_PERMANENCIA
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_016_PERMANENCIA';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_017_GRAU_PARENTESCO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_017_GRAU_PARENTESCO';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_018_DT_ADMISSAO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_018_DT_ADMISSAO';
	
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_019_DT_REF
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_019_DT_REF';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_020_BANCO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_020_BANCO';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_021_AGENCIA
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_021_AGENCIA';
	
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_022_AGENCIA_DG
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_022_AGENCIA_DG';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_023_CONTA_CORRENTE
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_023_CONTA_CORRENTE';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_024_CPF_CC
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_024_CPF_CC';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_025_NM_TITULAR_CC
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_025_NM_TITULAR_CC';
	
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_026_CD_CARDIRF
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_026_CD_CARDIRF';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_027_NR_CEP
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_027_NR_CEP';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_028_TP_LOGRADOURO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_028_TP_LOGRADOURO';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_029_NM_LOGRADOURO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_029_NM_LOGRADOURO';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_030_NUM
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_030_NUM';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_031_COMPL
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_031_COMPL';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_032_BAIRRO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_032_BAIRRO';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_033_MUNICIPIO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_033_MUNICIPIO';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_034_UF
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_034_UF';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_035_TEL_RESIDENCIAL
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_035_TEL_RESIDENCIAL';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_036_TEL_COMERCIAL
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_036_TEL_COMERCIAL';
	
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_037_TEL_CELULAR
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_037_TEL_CELULAR';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_038_NM_MAE
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_038_NM_MAE';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_039_NR_RG
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_039_NR_RG';
	
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_040_ORGAO_EMISSOR_RG
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_040_ORGAO_EMISSOR_RG';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_041_PAIS_RG
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_041_PAIS_RG';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_042_DT_EMISSAO_RG
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_042_DT_EMISSAO_RG';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_043_UF_RG
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_043_UF_RG';

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_044_PIS
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_044_PIS'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_045_CNS
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_045_CNS'; 
	
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_046_EMAIL
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_046_EMAIL'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_047_GRAU_ESCOLARIDADE
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_047_GRAU-ESCOLARIDADE'; 
	
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_048_RENDA_FAMILIAR
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_048_RENDA_FAMILIAR'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_049_CD_PROFISSAO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_049_CD_PROFISSAO'; 
	
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_050_CD_PAIS_ORIGEM
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_051_CD_PAIS_ORIGEM'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_051_DT_EXCLUSAO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_051_DT_EXCLUSAO'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_052_CD_MOTIVO_EXCLUSAO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_052_CD_MOTIVO_EXCLUSAO'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_053_CD_OPERACAO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_053_CD_OPERACAO'; 
	
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_054_CD_EMPRESA_TRANSF
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_054_CD_EMPRESA_TRANSF'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_055_NR_MATRICULA_TRANSF
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_055_NR_MATRICULA_TRANSF'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_056_NR_LOCAL_TRANSF
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_056_NR_LOCAL_TRANSF'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_057_NR_CATEGORIA_TRANSF
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_057_NR_CATEGORIA_TRANSF'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_058_CD_PLANO_TRANSF
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_058_CD_PLANO_TRANSF'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_059_MOTIVO_REMISSAO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_059_MOTIVO_REMISSAO'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_060_NR_CPF_NOVO_TITULAR
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_060_NR_CPF_NOVO_TITULAR'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_061_QTDE_PERM_MESES
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_061_QTDE_PERM_MESES'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_062_RDP_NOVO_TITULAR
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_062_RDP_NOVO_TITULAR'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_063_DT_INICIO_TRANSF
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_063_DT_INICIO_TRANSF'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_064_CD_STATUS
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_064_CD_STATUS'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_065_CD_ERROR
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_065_CD_ERROR'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_066_CD_DV
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_066_CD_DV'; 
	
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_067_BLOQ_EMPRESA_INADIMPLENCIA
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_067_BLOQ_EMPRESA_INADIMPLENCIA'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_068_CPT
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_068_CPT'; 
	
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_069_CD_EMPRESA_TITULAR
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_069_CD_EMPRESA_TITULAR'; 
	
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_070_NR_MATRICULA
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_70_NR_MATRICULA'; 
	
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_071_DIF_MATRICULA_TITULAR
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_071_DIF_MATRICULA_TITULAR'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_072_NR_TITULO_ELEITOR
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_072_NR_TITULO_ELEITOR'; 
	
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_073_NR_RIC
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_073_NR_RIC'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_074_NR_CERTIDAO_NASCIMENTO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_073_NR_RIC'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_075_NR_CARTEIRA_IDENT
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_075_NR_CARTEIRA_IDENT'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_076_IND_SEGURADO_CONTRIBUTARIO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_076_IND_SEGURADO_CONTRIBUTARIO'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_077_IND_COND_EX_EMPREGADO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_077_IND_COND_EX_EMPREGADO'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_078_IND_PERM_PLANO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_078_IND_PERM_PLANO'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_079_QTDE_MESES_CONTRIB
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_079_QTDE_MESES_CONTRIB'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_080_NM_BENEFICIARIO_COMPLETO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_080_NM_BENEFICIARIO_COMPLETO'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_081_IND_TITULAR_REMIDO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_081_IND_TITULAR_REMIDO'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_082_EMAIL_SEGURADORA
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_082_EMAIL_SEGURADORA'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_083_IND_PORTABILIDADE_01
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_083_IND_PORTABILIDADE_01'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_084_IND_PORTABILIDADE_02
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_084_IND_PORTABILIDADE_02'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_085_IND_CARENCIA
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_085_IND_CARENCIA'; 
	
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_086_CD_PRODUTO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_086_CD_PRODUTO'; 
	
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_087_CD_IND_PRODUTO_ANTERIOR_SAS
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_087_CD_IND_PRODUTO_ANTERIOR_SAS'; 
	
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_088_CID01
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_088_CID01'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_089_CID02
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_089_CID02'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_090_CID03
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_090_CID03'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_091_CID04
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_091_CID04'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_092_CID05
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_092_CID05'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_093_CID06
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_093_CID06'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_094_CID07
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_094_CID07'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_095_CID08
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_095_CID08'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_096_CID09
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_096_CID09'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_097_CID10
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_097_CID10'; 

	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_098_IBGE
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_098_IBGE'; 
	
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_099_CBO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_099_CBO'; 
	
	call PROC_LOG_MESSAGE('LINHA - 304');
	select	ID into VAR_ID_COLUMN_100_DIF_TRANSF
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_100_DIF_TRANSF'; 
		
	call PROC_LOG_MESSAGE('LINHA - 952');
	/*********************************************************************************************************************************************/
	/*********************************************************************************************************************************************/	
	/* BENEFICIÁRIO */
	...
	call PROC_LOG_MESSAGE('LINHA - 2413');
	/*********************************************************************************************************************************************/
	/*********************************************************************************************************************************************/		
	call PROC_LOG_MESSAGE('LINHA - 2416');
	update TB_ARQUIVO_INPUT_COLS_DEF
	set
			NM_COLUMN 			= 'COLUMN_050_CD_PAIS_ORIGEM'
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN 			= 'COLUMN_051_CD_PAIS_ORIGEM'; 

	/*********************************************************************************************************************************************/
	call PROC_LOG_MESSAGE('LINHA - 2424');
	update TB_ARQUIVO_INPUT_COLS_DEF
	set
			CD_TYPE				= VAR_COL_INT
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		ID					= VAR_ID_COLUMN_010_CD_PLANO;
	
	delete from TB_BENEFICIARIO_COLS
	where	CD_BENEFICIARIO_COLS_DEF	= VAR_CD_BENEFICIARIO_COLS_DEF_REF_CODE
	and		ID_ARQUIVO_INPUT_COLS_DEF	= VAR_ID_COLUMN_010_CD_PLANO;
		
	/*********************************************************************************************************************************************/
	call PROC_LOG_MESSAGE('LINHA - 2436');
	update TB_ARQUIVO_INPUT_COLS_DEF
	set
			CD_TYPE				= VAR_COL_VARCHAR
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		ID					= VAR_ID_COLUMN_021_AGENCIA;	
	...
	set
			CD_TYPE				= VAR_COL_VARCHAR
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		ID					= VAR_ID_COLUMN_039_NR_RG;	
	...
	set
			CD_TYPE				= VAR_COL_VARCHAR
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		ID					= VAR_ID_COLUMN_038_NM_MAE;
	...
	set
			CD_TYPE				= VAR_COL_VARCHAR
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		ID					= VAR_ID_COLUMN_064_CD_STATUS;

	call PROC_LOG_MESSAGE('LINHA - 2464');
	update TB_ARQUIVO_INPUT_COLS_DEF
	set
			CD_TYPE				= VAR_COL_DATE
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		ID					= VAR_ID_COLUMN_051_DT_EXCLUSAO;
	
	call PROC_LOG_MESSAGE('LINHA - 2423');
	/*********************************************************************************************************************************************/
	/*********************************************************************************************************************************************/	
