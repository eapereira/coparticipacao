...
BEGIN
	...
	declare VAR_ID_COLUMN_001_NR_CARTAO_DEPENDENTE						bigint( 17 );
	...
	declare VAR_ID_COLUMN_005_DESCR_MOTIVO								bigint( 17 );
	declare VAR_ID_COLUMN_006_DT_INICIO									bigint( 17 );
	declare VAR_ID_COLUMN_007_DT_FIM									bigint( 17 );	
	...
	insert into TB_ARQUIVO_INPUT_COLS_DEF(
		...
		'COLUMN_001_NR_CARTAO_DEPENDENTE',
		VAR_COL_VARCHAR,
		null,
		VAR_CD_ORDEM,
	...
	select max( ID ) into VAR_ID_COLUMN_001_NR_CARTAO_DEPENDENTE
	...
	select max( ID ) into VAR_ID_COLUMN_005_DESCR_MOTIVO
	from TB_ARQUIVO_INPUT_COLS_DEF;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_006_DT_INICIO
	from TB_ARQUIVO_INPUT_COLS_DEF;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_007_DT_FIM
	from TB_ARQUIVO_INPUT_COLS_DEF;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	insert into TB_ISENTO_INPUT_SHEET_COLS(
		...
		VAR_ID_COLUMN_005_DESCR_MOTIVO,
		VAR_CD_ORDEM,
