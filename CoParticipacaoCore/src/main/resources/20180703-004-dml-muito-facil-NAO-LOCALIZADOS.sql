...
BEGIN
	...
	select max( ID ) into VAR_SHEET01_COLUMN_04_NM_TITULAR from TB_REGISTER_COLUMN;
	...
	select max( ID ) into VAR_SHEET02_COLUMN_04_NM_TITULAR from TB_REGISTER_COLUMN;
