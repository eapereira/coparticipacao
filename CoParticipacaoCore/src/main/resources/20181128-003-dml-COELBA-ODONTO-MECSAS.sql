...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20181128-002-dml-COELBA-ODONTO.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181128-003-dml-COELBA-ODONTO-MECSAS.sql';
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO,
		'^(180612)\\.(MECSAS)\\.([0-9]{4})([0-9]{2})\\.([0-9]{3})\\.(xlsx|XLSX)$',
	...
	call PROC_LOG_MESSAGE('LINHA - 1771');
	insert into TB_BENEFICIARIO_COLS(
		CD_BENEFICIARIO_COLS_DEF,
		ID_ARQUIVO_INPUT_SHEET_COLS_DEF,
		...
		DT_ALTERED ) values (
		VAR_CD_BENEFICIARIO_COLS_NR_MATRICULA_ESPECIAL,
		VAR_ID_SHEET05_COLUMN_014_NR_MATRICULA_ESPECIAL,
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		VAR_ID_SHEET05_COLUMN_018_CD_CARTAO_DEPENDENTE,
