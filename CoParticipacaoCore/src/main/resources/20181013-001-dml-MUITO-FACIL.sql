...
BEGIN
	...
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181013-001-dml-MUITO-FACIL.sql';
	...
	select	ID into VAR_ID_COLUMN_21_NM_TITULAR
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where 	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN			= 'COLUMN_21_NOME_COMPLETO_TITULAR';
	
	call PROC_LOG_MESSAGE('LINHA - 282');
	select	ID into VAR_ID_COLUMN_16_DT_NASCIMENTO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where 	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN			= 'COLUMN_16_DATA_NASCIMENTO';
