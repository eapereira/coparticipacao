...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20181011-006-dml-INTERVALOR-8EAQR.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181011-007-dml-INTERVALOR-8EAQS.sql';
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO,
		'^(INTERVALOR)\\.(8EAQS)\\.([0-9]{4})([0-9]{2})\\.([0-9]{3})\\.(txt|TXT)$',
	...
	insert into TB_REGRA(
		...
		DT_ALTERED ) values (
		'INTERVALOR.8EAQS.01',
		'INTERVALOR.8EAQS - Regra para Valor do Arquivo FATUCOPA INTERVALOR dividido por 100',
		1, /* SIMPLES */
		0,
		VAR_ID_ARQUIVO_INPUT_SHEET,
