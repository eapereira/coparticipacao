...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20181008-002-dml-MUITO-FACIL.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181008-003-dml-MARJAN.sql';
	...
	set VAR_ID_ARQUIVO_INPUT = FUNC_FIND_ARQUIVO_INPUT( 'MARJAN','8C5Z8');
	...
	select	ID into VAR_ID_COLUMN_13_POSITIVO_NEGATIVO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where 	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN			= 'COLUMN_13_POSITIVO_NEGATIVO';
	
	call PROC_LOG_MESSAGE('LINHA - 280');
	select	ID into VAR_ID_COLUMN_09_NR_CPF
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where 	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN			= 'COLUMN_09_CPF';
	
	call PROC_LOG_MESSAGE('LINHA - 286');
	select	ID into VAR_ID_COLUMN_19_NR_MATRICULA
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where 	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN			= 'COLUMN_19_NR_MATRICULA';

	call PROC_LOG_MESSAGE('LINHA - 292');
	select	ID into VAR_ID_COLUMN_07_NM_BENEFICIARIO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where 	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN			= 'COLUMN_07_NM_DEPENDENTE';
	...
	call PROC_LOG_MESSAGE('LINHA - 371');
	/*********************************************************************************************************************************************/
	call PROC_LOG_MESSAGE('LINHA - 373');
    update TB_LANCAMENTO_INPUT_COLS
    set
    		ID_ARQUIVO_INPUT_COLS_DEF	= VAR_ID_COLUMN_19_NR_MATRICULA
	...
	set VAR_ID_ARQUIVO_INPUT = FUNC_FIND_ARQUIVO_INPUT( 'MARJAN','8C5Z9');
	...
	call PROC_LOG_MESSAGE('LINHA - 276');
	select	ID into VAR_ID_COLUMN_13_POSITIVO_NEGATIVO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where 	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN			= 'COLUMN_13_POSITIVO_NEGATIVO';
	...
	/*********************************************************************************************************************************************/
	call PROC_LOG_MESSAGE('LINHA - 258');
	set VAR_ID_ARQUIVO_INPUT = FUNC_FIND_ARQUIVO_INPUT( 'MARJAN','8C7XX');
	...
	/*********************************************************************************************************************************************/
	call PROC_LOG_MESSAGE('LINHA - 258');
	set VAR_ID_ARQUIVO_INPUT = FUNC_FIND_ARQUIVO_INPUT( 'MARJAN','8C7XY');
