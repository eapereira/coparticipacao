...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20181107-008-dml-TECHNIT.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181107-009-dml-TECHNIT-MECSAS.sql';
