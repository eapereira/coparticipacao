...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20180915-005-dml-HOC-ISENTOS-VALOR.sql';
	...
	declare VAR_COLUMN_02_NR_MATRICULA_EMPRESA		bigint( 17 );
	declare VAR_COLUMN_03_NR_CPF					bigint( 17 );
	declare VAR_COLUMN_04_NR_LOCAL					bigint( 17 );
	declare VAR_COLUMN_05_NR_RDP					bigint( 17 );
	declare VAR_COLUMN_06_NM_DEPENDENTE				bigint( 17 );
	declare VAR_COLUMN_07_NM_ALIAS_01				bigint( 17 );
	declare VAR_COLUMN_08_NM_ALIAS_02				bigint( 17 );
	declare VAR_COLUMN_09_DT_NASCIMENTO				bigint( 17 );
	declare VAR_COLUMN_10_DT_ADMISSAO				bigint( 17 );
	declare VAR_COLUMN_11_DT_DEMISSAO				bigint( 17 );
	declare VAR_COLUMN_12_VL_PRINCIPAL				bigint( 17 );
	...
	declare VAR_CD_BENEFICIARIO_COLS_NM_ALIAS_01           			   	bigint( 17 ) default 116;
	declare VAR_CD_BENEFICIARIO_COLS_NM_ALIAS_02           			   	bigint( 17 ) default 117;
	declare VAR_CD_BENEFICIARIO_COLS_NM_ALIAS_03           			   	bigint( 17 ) default 118;
	...
	declare VAR_CD_FORMAT_DDMMYYYY										varchar( 10 ) default 'dd/MM/yyyy';
	/***********************************************************************************************************************/
	...
	/***********************************************************************************************************************/		
	call PROC_LOG_MESSAGE('LINHA - 100');
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO,
		'^(0444)\\.(NAO\\-LOCALIZADO)\\.([0-9]{4})([0-9]{2})\\.([0-9]{3})\\.(xlsx|XLSX)$',
	...
	select max( ID ) into VAR_COLUMN_01_NR_MATRICULA from TB_REGISTER_COLUMN;
	...
	insert into TB_REGISTER_COLUMN(
		...
		DT_ALTERED ) values (	
		VAR_ID_REGISTER,
		'COLUMN_02_NR_MATRICULA_EMPRESA',
		VAR_COL_LONG,
		null,
		VAR_CD_ORDEM,
	...
	select max( ID ) into VAR_COLUMN_02_NR_MATRICULA_EMPRESA
	...
	call PROC_LOG_MESSAGE('LINHA - 307');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	select max( ID ) into VAR_COLUMN_04_NR_LOCAL
	from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_COLUMN_05_NR_RDP
	from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_COLUMN_06_NM_DEPENDENTE 
	from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_COLUMN_07_NM_ALIAS_01 
	from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_COLUMN_08_NM_ALIAS_02 
	from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_COLUMN_09_DT_NASCIMENTO
	from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_COLUMN_10_DT_ADMISSAO
	from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_COLUMN_11_DT_DEMISSAO
	from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_COLUMN_12_VL_PRINCIPAL 
	from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		VAR_COLUMN_02_NR_MATRICULA_EMPRESA,
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		DT_CREATED,
		DT_ALTERED ) values (
		VAR_CD_BENEFICIARIO_COLS_NM_ALIAS_01,
		VAR_COLUMN_07_NM_ALIAS_01,
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		DT_CREATED,
		DT_ALTERED ) values (
		VAR_CD_BENEFICIARIO_COLS_NM_ALIAS_02,
		VAR_COLUMN_08_NM_ALIAS_02,
