...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20181128-010-dml-COELBA-SAUDE-071769.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181128-011-dml-COELBA-SAUDE-MECSAS2.sql';
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO,
		'^(071769)\\.(MECSAS2)\\.([0-9]{4})([0-9]{2})\\.([0-9]{3})\\.(xlsx|XLSX)$',
