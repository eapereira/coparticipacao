...
BEGIN
	...
	/*****************************************************************************************************************************************************/
	call PROC_LOG_MESSAGE('LINHA - 478');
	insert into TB_REGISTER(
		ID_ARQUIVO_INPUT_SHEET,
		NM_REGISTER,
		CD_REGISTER,
	...
	/*****************************************************************************************************************************************************/
	call PROC_LOG_MESSAGE('LINHA - 712');
	insert into TB_REGISTER(
		ID_ARQUIVO_INPUT_SHEET,
		NM_REGISTER,
		CD_REGISTER,
	...
	/*****************************************************************************************************************************************************/
	call PROC_LOG_MESSAGE('LINHA - 974');
	insert into TB_REGISTER(
		ID_ARQUIVO_INPUT_SHEET,
		NM_REGISTER,
		CD_REGISTER,
	...
	select max( ID ) into VAR_SHEET05_COLUMN_005_NR_MATRICULA_EMPRESA 
	from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	insert into TB_ISENTO_INPUT_SHEET_COLS(
		...
		DT_ALTERED ) values (
		VAR_ID_ISENTO_INPUT_SHEET,
		VAR_SHEET05_COLUMN_005_NR_MATRICULA_EMPRESA,
		VAR_CD_ISENTO_COLS_DEF_NR_MATRICULA_EMPRESA,
