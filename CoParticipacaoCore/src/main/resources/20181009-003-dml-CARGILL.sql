...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20181009-002-dml-HOC.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181009-003-dml-CARGILL.sql';
	...
	declare VAR_CD_FORMAT												varchar( 10 ) default 'ddMMyyyy';
	...
	set VAR_ID_ARQUIVO_INPUT = FUNC_FIND_ARQUIVO_INPUT( 'CARGILL','00192');
	
	call PROC_LOG_MESSAGE('LINHA - 269');
	select 	ID into VAR_ID_LANCAMENTO_INPUT
	from 	TB_LANCAMENTO_INPUT
	where	ID_ARQUIVO_INPUT = VAR_ID_ARQUIVO_INPUT;
		
	call PROC_LOG_MESSAGE('LINHA - 280');
	select	ID into VAR_ID_COLUMN_12_NR_CPF
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where 	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN			= 'COLUMN_12_NR_CPF';
	
	call PROC_LOG_MESSAGE('LINHA - 286');
	select	ID into VAR_ID_COLUMN_05_NR_MATRICULA_DEPENDENTE
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where 	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN			= 'COLUMN_05_NR_MATRICULA_DEPENDENTE';
	...
	call PROC_LOG_MESSAGE('LINHA - 292');
	select	ID into VAR_ID_COLUMN_04_NR_MATRICULA_TITULAR
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where 	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN			= 'COLUMN_04_NR_MATRICULA_TITULAR';
	...
	/*********************************************************************************************************************************************/		
    call PROC_LOG_MESSAGE('LINHA - 351');
	set VAR_ID_ARQUIVO_INPUT = FUNC_FIND_ARQUIVO_INPUT( 'CARGILL','00196');
	...
	call PROC_LOG_MESSAGE('LINHA - 458');
	/*********************************************************************************************************************************************/
	call PROC_LOG_MESSAGE('LINHA - 384');
    update TB_LANCAMENTO_INPUT_COLS
    set
    		ID_ARQUIVO_INPUT_COLS_DEF	= VAR_ID_COLUMN_05_NR_MATRICULA_DEPENDENTE
    where 	ID_LANCAMENTO_INPUT			= VAR_ID_LANCAMENTO_INPUT
	...
	/*********************************************************************************************************************************************/
	/*********************************************************************************************************************************************/		
	call PROC_LOG_MESSAGE('LINHA - 541');
	update TB_ARQUIVO_INPUT_COLS_DEF
	set
			CD_FORMAT 			= VAR_CD_FORMAT
	where	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	...
	set VAR_ID_ARQUIVO_INPUT = FUNC_FIND_ARQUIVO_INPUT( 'CARGILL','00197');
