...
BEGIN
	...
	declare VAR_ID_SHEET01_COLUMN_016_NR_CERTIFICADO 			bigint( 17 );
	declare VAR_ID_SHEET01_COLUMN_017_NR_MATRICULA_ESPECIAL 	bigint( 17 );
	declare VAR_ID_SHEET01_COLUMN_018_SUBFATURA 				bigint( 17 );	
	...
	select max( ID ) into VAR_ID_SHEET01_COLUMN_016_NR_CERTIFICADO
	from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	insert into TB_ARQUIVO_INPUT_SHEET_COLS_DEF(
		...
		DT_ALTERED ) values (	
		VAR_ID_ARQUIVO_INPUT_SHEET,
		'COLUMN_017_NR_MATRICULA_ESPECIAL',
		VAR_COL_LONG,
		null,
		VAR_CD_ORDEM,
	...
	select max( ID ) into VAR_ID_SHEET01_COLUMN_017_NR_MATRICULA_ESPECIAL
	from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_SHEET01_COLUMN_018_SUBFATURA
	from TB_ARQUIVO_INPUT_SHEET_COLS_DEF; 
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
