...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20180928-003-dml-HOC.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20180929-002-dml.sql';
	...
	declare VAR_TP_REPORT_QUERY_BY_CD_CONTRATO							int( 3 ) default 0;
	...
	update	TB_EMPRESA
	set
			TP_REPORT_QUERY	= VAR_TP_REPORT_QUERY_BY_CD_CONTRATO
	...
	update	TB_EMPRESA
	set
			TP_REPORT_QUERY	= VAR_TP_REPORT_QUERY_BY_PERIODO_ONLY
