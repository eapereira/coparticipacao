...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20181011-008-dml-AUTOMIND.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181011-009-dml-AUTOMIND-MECSAS.sql';
