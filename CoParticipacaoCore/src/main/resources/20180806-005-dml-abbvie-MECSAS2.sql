...
BEGIN
	...
	select max( ID ) into VAR_ID_COLUMN_01_NM_EMPRESA from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	...
	select max( ID ) into VAR_ID_COLUMN_02_NR_MATRICULA from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_03_UPI from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_04_NM_BENEFICIARIO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_05_NM_ORGAO_RESPONSAVEL from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_06_DT_ADMISSAO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_07_DT_NASCIMENTO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_08_ESTADO_CIVIL from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_09_NACIONALIDADE from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_10_NATURALIDADE from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_11_NM_MAE from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_12_NM_PAI from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_13_ENDERECO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_14_BAIRRO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_15_CEP from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_16_MUNICIPIO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_17_TELEFONE from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_18_CELULAR from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_19_EMAIL from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_20_NR_CPF from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_21_NR_RG from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_22_NR_TITULO_ELEITOR from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_23_CTPS from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_24_CNH from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_25_CERT_MILITAR from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_26_PIS from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_27_LOTACAO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_28_CENTRO_CUSTO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_29_BANCO_PAGTO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_31_TP_CONTA_CORRENTE from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_32_CONTA_CORRENTE_PAGTO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_33_VINCULO_EMPREGATICIO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_34_CARGO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_35_SALARIO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_36_NM_SINDICATO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_37_CBO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_38_HORARIO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_39_SITUACAO from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_40_NM_GESTOR from TB_ARQUIVO_INPUT_SHEET_COLS_DEF;
	set VAR_COL_INDEX = VAR_COL_INDEX + 1;
