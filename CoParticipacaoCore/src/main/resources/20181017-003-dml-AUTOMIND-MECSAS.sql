...
BEGIN
	...
	declare VAR_ID_SHEET05_COLUMN_011_NR_MATRICULA_ESPECIAL bigint( 17 );
	declare VAR_ID_SHEET05_COLUMN_012_DT_NASCIMENTO 		bigint( 17 );
	declare VAR_ID_SHEET05_COLUMN_013_DT_INICIO_VIGENCIA 	bigint( 17 );
	declare VAR_ID_SHEET05_COLUMN_014_NR_MATRICULA_ESPECIAL bigint( 17 );
	declare VAR_ID_SHEET05_COLUMN_015_DT_REATIVACAO 		bigint( 17 );
	declare VAR_ID_SHEET05_COLUMN_016_DT_CANCELAMENTO 		bigint( 17 );
	declare VAR_ID_SHEET05_COLUMN_017_NR_CPF 				bigint( 17 );
	declare VAR_ID_SHEET05_COLUMN_018_CD_CARTAO_DEPENDENTE 	bigint( 17 );
	declare VAR_ID_SHEET05_COLUMN_019_NM_MAE 				bigint( 17 );
	...
	call PROC_LOG_MESSAGE('LINHA - 415');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 467');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 545');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 573');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 651');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 679');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 707');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 733');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 869');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 897');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 923');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 1026');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 1158');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 1184');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	call PROC_LOG_MESSAGE('LINHA - 1210');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	select max( ID ) into VAR_ID_SHEET05_COLUMN_011_NR_MATRICULA_ESPECIAL
	from TB_REGISTER_COLUMN; 
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;

	call PROC_LOG_MESSAGE('LINHA - 1290');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	select max( ID ) into VAR_ID_SHEET05_COLUMN_012_DT_NASCIMENTO
	from TB_REGISTER_COLUMN; 
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;

	call PROC_LOG_MESSAGE('LINHA - 1318');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	select max( ID ) into VAR_ID_SHEET05_COLUMN_013_DT_INICIO_VIGENCIA
	from TB_REGISTER_COLUMN; 
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;

	call PROC_LOG_MESSAGE('LINHA - 1346');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	select max( ID ) into VAR_ID_SHEET05_COLUMN_014_NR_MATRICULA_ESPECIAL
	from TB_REGISTER_COLUMN; 
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;

	call PROC_LOG_MESSAGE('LINHA - 1372');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	select max( ID ) into VAR_ID_SHEET05_COLUMN_015_DT_REATIVACAO
	from TB_REGISTER_COLUMN; 
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_SHEET05_COLUMN_016_DT_CANCELAMENTO
	from TB_REGISTER_COLUMN; 
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	
	call PROC_LOG_MESSAGE('LINHA - 1428');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	select max( ID ) into VAR_ID_SHEET05_COLUMN_017_NR_CPF
	from TB_REGISTER_COLUMN; 
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	
	call PROC_LOG_MESSAGE('LINHA - 1454');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
		...
		DT_ALTERED ) values (	
		VAR_ID_REGISTER,
		'COLUMN_018_CD_CARTAO_DEPENDENTE',
		VAR_COL_VARCHAR,
		null,
		VAR_CD_ORDEM,
	...
	select max( ID ) into VAR_ID_SHEET05_COLUMN_018_CD_CARTAO_DEPENDENTE
	from TB_REGISTER_COLUMN; 
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	
	call PROC_LOG_MESSAGE('LINHA - 1480');
	insert into TB_REGISTER_COLUMN(
		ID_REGISTER,
		NM_COLUMN,
		CD_TYPE,
	...
	select max( ID ) into VAR_ID_SHEET05_COLUMN_019_NM_MAE
	from TB_REGISTER_COLUMN; 
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		VAR_ID_SHEET01_COLUMN_002_NR_SUB_FATURA,
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		DT_ALTERED ) values (
		VAR_CD_BENEFICIARIO_COLS_DEF_NR_CPF,
		VAR_ID_SHEET05_COLUMN_017_NR_CPF,
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		DT_ALTERED ) values (
		VAR_CD_BENEFICIARIO_COLS_DEF_DT_NASCIMENTO,
		VAR_ID_SHEET05_COLUMN_012_DT_NASCIMENTO,
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		DT_ALTERED ) values (
		VAR_CD_BENEFICIARIO_COLS_NR_SUBFATURA,
		VAR_ID_SHEET05_COLUMN_002_NR_SUB_FATURA,
