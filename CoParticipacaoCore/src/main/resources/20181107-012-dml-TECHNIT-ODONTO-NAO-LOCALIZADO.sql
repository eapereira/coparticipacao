...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20181107-011-dml-TECHNIT-MECSAS2.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181107-012-dml-TECHNIT-NAO-LOCALIZADO.sql';
