...
BEGIN
	...
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181201-006-dml-SPREAD-SAUDE-NAO-LOCALIZADO.sql';
	...
	declare VAR_ID_COLUMN_001_NR_SUBFATURA 				bigint( 17 );
	...
	declare VAR_ID_COLUMN_006_NR_CERTIFICADO 			bigint( 17 );
	declare VAR_ID_COLUMN_007_NR_MATRICULA_ESPECIAL 	bigint( 17 );
	declare VAR_ID_COLUMN_008_CD_CONTRATO 				bigint( 17 );
	...
	select max( ID ) into VAR_ID_COLUMN_001_NR_SUBFATURA
	...
	select max( ID ) into VAR_ID_COLUMN_006_NR_CERTIFICADO
	from TB_REGISTER_COLUMN; 
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_008_CD_CONTRATO
	from TB_REGISTER_COLUMN; 
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		VAR_ID_COLUMN_006_NR_CERTIFICADO,
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		VAR_ID_COLUMN_001_NR_SUBFATURA ,
