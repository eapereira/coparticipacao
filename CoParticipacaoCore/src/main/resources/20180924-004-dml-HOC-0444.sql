...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20180924-002-dml-HOC-MECSAS.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20180924-004-dml-HOC-0444.sql';
	...
	where	CD_BENEFICIARIO_COLS_DEF	= VAR_CD_BENEFICIARIO_COLS_DEF_NR_DF
	and		ID_ARQUIVO_INPUT_COLS_DEF	= VAR_ID_COLUMN_04_COD_TITULAR;
