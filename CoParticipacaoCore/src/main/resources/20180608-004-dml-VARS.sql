 ...
 */
drop procedure if exists PROC_CREATE_COPA;

delimiter $$

create procedure PROC_CREATE_COPA()
LANGUAGE SQL
DETERMINISTIC
SQL SECURITY DEFINER
COMMENT 'Script para configurar o Hospital Oswaldo Cruz'
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20180608-003-dml.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20180608-004-dml-VARS.sql';
