...
BEGIN
	...
	select max( ID ) into VAR_ID_COLUMN_01_PREFIXO_EMPRESA from TB_REGISTER_COLUMN; 
	...
	select max( ID ) into VAR_ID_COLUMN_02_EMPRESA from TB_REGISTER_COLUMN; 
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_03_NR_MATRICULA from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_04_DV from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_05_RDP from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_06_DC from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_07_COD_LOCAL from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_08_CAT_FUNCIONAL from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_09_SETOR from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_10_ESTADO_CIVIL from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_11_PLANO from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_12_PLANO_AGREG from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_13_DT_INCLUSAO from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_14_PLANO_COMPL from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_15_CPF from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_18_AGENCIA_DV from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_25_GRAU_PARENTESCO from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_30_DT_REFERENCIA from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_31_CD_ORCAO_LOTACAO from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_38_NUM_LOGRADOURO from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_51_ORGAO_EXPEDIDOR from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_54_DT_EMISSAO from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_55_NUM_PIS_PASEP from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_56_NUM_CNS from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_62_CD_IDENTIFICADOR from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_63_CD_CPT from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_64_ID_BLOQ_BENEF from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_65_EMPRESA_TIT_AGREGADO from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_66_MATRICULA_TIT_AGREGADO from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_67_DECL_NASC_VIVO from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_68_TITULO_ELEITOR from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_69_NUM_RIC from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_70_ID_CONTRIBUTARIO from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_71_QTDE_CONTRIB from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_72_ID_EX_EMPREGADO from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_73_ID_MANTER_PLANO from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_74_NM_BENEF_COMPLETO from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_75_CD_OPERACAO from TB_REGISTER_COLUMN;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
