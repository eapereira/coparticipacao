...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20181128-008-dml-COELBA-SAUDE.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181128-009-dml-COELBA-SAUDE-MECSAS.sql';
