...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20181009-001-dml-ABBVIE.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181009-002-dml-HOC.sql';
	...
	set VAR_ID_ARQUIVO_INPUT = FUNC_FIND_ARQUIVO_INPUT( '0444','0444');
	...
	select	ID into VAR_ID_COLUMN_12_CPF_DEPENDENTE
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where 	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN			= 'COLUMN_12_CPF_DEPENDENTE';
    ...
    set
    		ID_ARQUIVO_INPUT_COLS_DEF	= VAR_ID_COLUMN_05_COD_DEPENDENTE
