...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20180929-002-dml.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181008-002-dml-MUITO-FACIL.sql';
	...
	set VAR_ID_ARQUIVO_INPUT = FUNC_FIND_ARQUIVO_INPUT( 'MUITO-FACIL','8CHE8');
	...
	select	ID into VAR_ID_COLUMN_22_NR_MATRICULA
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where 	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN			= 'COLUMN_22_MATRICULA';

	call PROC_LOG_MESSAGE('LINHA - 295');
	select	ID into VAR_ID_COLUMN_07_NM_BENEFICIARIO
	from 	TB_ARQUIVO_INPUT_COLS_DEF
	where 	ID_ARQUIVO_INPUT	= VAR_ID_ARQUIVO_INPUT
	and		NM_COLUMN			= 'COLUMN_07_NOME_COMPLETO_DEPENDENTE';
	...
	set VAR_ID_ARQUIVO_INPUT = FUNC_FIND_ARQUIVO_INPUT( 'MUITO-FACIL','8CH5Y');
    ...
    call PROC_LOG_MESSAGE('LINHA - 397');
    insert into TB_LANCAMENTO_INPUT_COLS (
        ID_LANCAMENTO_INPUT,
        ID_ARQUIVO_INPUT_COLS_DEF,
        CD_LANCAMENTO_COLS_DEF,
