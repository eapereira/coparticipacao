...
select
	...
	titular.NR_MATRICULA_ESPECIAL,
	titular.NR_SUBFATURA,
    concat( subfatura.NR_SUBFATURA, ' - ', subfatura.NM_SUBFATURA ) NM_EMPRESA,
    titular.NM_TITULAR,
    titular.NM_TITULAR NM_BENEFICIARIO,
...
select
    ...
    subfatura.NM_SUBFATURA NM_EMPRESA,
    titular.NM_TITULAR,
    dependente.NM_DEPENDENTE NM_BENEFICIARIO,
...
select
    ...
    spread.ID_CONTRATO,
    spread.NR_SUBFATURA,
	concat( spread.NR_SUBFATURA, ' - ', spread.NM_EMPRESA ) NM_EMPRESA,
    sum( spread.VL_PRINCIPAL ) VL_PRINCIPAL,
    sum( spread.VL_ISENTO ) VL_ISENTO,
	spread.VERSION,
	spread.USER_CREATED,
