...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20181009-003-dml-CARGILL.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181010-002-dml-CARGILL.sql';
	...
	update TB_CONTRATO
	set
			ID_CONTRATO_PARENT	= VAR_ID_CONTRATO
	where	ID_EMPRESA			= VAR_ID_EMPRESA
	and		CD_CONTRATO			= '00192-PRN';
	...
	call PROC_LOG_MESSAGE('LINHA - 312');
	update TB_CONTRATO
	set
			ID_CONTRATO_PARENT	= VAR_ID_CONTRATO
	where	ID_EMPRESA			= VAR_ID_EMPRESA
	and		CD_CONTRATO			= '00197-PRN';	
