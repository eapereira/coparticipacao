...
BEGIN
	...
	declare VAR_COLUMN_02_NM_TITULAR				bigint( 17 );
	declare VAR_COLUMN_03_NR_CPF_TITULAR			bigint( 17 );
	...
	select max( ID ) into VAR_COLUMN_01_NR_MATRICULA_TITULAR from TB_ARQUIVO_INPUT_COLS_DEF;
	...
	select max( ID ) into VAR_COLUMN_02_NM_TITULAR from TB_ARQUIVO_INPUT_COLS_DEF;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_COLUMN_03_NR_CPF_TITULAR from TB_ARQUIVO_INPUT_COLS_DEF;
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
