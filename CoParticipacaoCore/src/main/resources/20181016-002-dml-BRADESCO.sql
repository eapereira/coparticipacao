...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20181015-001-dml-PRODUCAO.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181016-002-dml-BRADESCO.sql';
