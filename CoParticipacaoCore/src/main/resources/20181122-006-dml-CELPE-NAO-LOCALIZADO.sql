...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20181122-005-dml-CELPE-MECSAS2.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181122-006-dml-CELPE-NAO-LOCALIZADO.sql';
