...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20181201-004-dml-SPREAD-SAUDE-MECSAS2.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181201-005-dml-SPREAD-SAUDE-073828.sql';
	...
	declare VAR_NR_MATRICULA_BASE											bigint( 17 ) default 773828000000000;
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO,
		'^(073828)\\.(073828)\\.([0-9]{4})([0-9]{2})\\.([0-9]{3})\\.(xlsx|XLSX)$',
	...
	insert into TB_LANCAMENTO_INPUT_SHEET_COLS (
		...
		DT_ALTERED ) values (
		VAR_ID_LANCAMENTO_INPUT_SHEET,
		VAR_COL_LANCAMENTO_DT_UTILIZACAO,
		VAR_ID_SHEET01_REG02_COLUMN_002_DT_UTILIZACAO,
	...
	insert into TB_LANCAMENTO_INPUT_SHEET_COLS (
		...
		VAR_ID_SHEET01_REG02_COLUMN_019_SUBFATURA,
	...
	insert into TB_LANCAMENTO_INPUT_SHEET_COLS (
		...
		DT_ALTERED ) values (
		VAR_ID_LANCAMENTO_INPUT_SHEET,
		VAR_COL_LANCAMENTO_DESCR_UTILIZACAO,
		VAR_ID_SHEET01_REG02_COLUMN_008_NM_SERVICO,
	...
	insert into TB_REGRA(
		...
		DT_ALTERED ) values (
		'REGRA.073828.01',
		'Regra para subtrair o NR_MATRICULA_TITULAR do beneficiário por 738280000000000',
	...
	insert into TB_ARQUIVO_OUTPUT(
		...
		DT_ALTERED ) values (
		VAR_ID_ARQUIVO_INPUT,
		'SPREAD-Bradesco (Saúde) - Coparticipação_({YYYY}{MM}).xlsx',
    ...
    where 	NM_VIEW = 'VW_COPARTICIPACAO_SPREAD_SAUDE';
	...
	select 	ID into VAR_ID_VIEW_DESTINATION
	from 	TB_VIEW_DESTINATION
    where 	NM_VIEW = 'VW_COPARTICIPACAO_RESUMO_SPREAD_SAUDE';
	...
	insert into TB_ARQUIVO_OUTPUT_DESCONHECIDO(
		...
		DT_ALTERED ) values (
		VAR_ID_ARQUIVO_INPUT,
		'NAO-LOCALIZADO-SPREAD-SAUDE-{YYYY}{MM}.xlsx',
