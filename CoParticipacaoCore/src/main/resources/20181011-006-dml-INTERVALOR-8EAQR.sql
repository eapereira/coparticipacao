...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20181011-005-dml-INTERVALOR-8EAQG.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181011-006-dml-INTERVALOR-8EAQR.sql';
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO,
		'^(INTERVALOR)\\.(8EAQR)\\.([0-9]{4})([0-9]{2})\\.([0-9]{3})\\.(txt|TXT)$',
	...
	insert into TB_REGRA(
		...
		DT_CREATED,
		DT_ALTERED ) values (
		'INTERVALOR.8EAQR - Regra para Valor do Arquivo FATUCOPA INTERVALOR dividido por 100',
		1, /* SIMPLES */
		0,
		VAR_ID_ARQUIVO_INPUT,
