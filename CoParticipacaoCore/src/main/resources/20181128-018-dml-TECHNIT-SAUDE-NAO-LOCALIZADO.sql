...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20181128-017-dml-TECHNIT-SAUDE-MECSAS2.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181128-018-dml-TECHNIT-SAUDE-NAO-LOCALIZADO.sql';
