...
BEGIN
	...
	declare VAR_ID_COLUMN_002_NM_TITULAR 				bigint( 17 );
	declare VAR_ID_COLUMN_003_NM_BENEFICIARIO 			bigint( 17 );
	declare VAR_ID_COLUMN_004_NR_CPF 					bigint( 17 );
	declare VAR_ID_COLUMN_005_VL_FATOR_MODERADOR 		bigint( 17 );
	declare VAR_ID_COLUMN_006_DESCR_PROFISSAO 			bigint( 17 );
	declare VAR_ID_COLUMN_007_NR_MATRICULA_ESPECIAL 	bigint( 17 );
	declare VAR_ID_COLUMN_008_VL_FATOR_MODERADOR_INSS 	bigint( 17 );
	declare VAR_ID_COLUMN_009_NR_SUBFATURA 				bigint( 17 );
	declare VAR_ID_COLUMN_010_CD_CONTRATO 				bigint( 17 );
	...
	select max( ID ) into VAR_ID_COLUMN_002_NM_TITULAR
	from TB_REGISTER_COLUMN; 
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_005_VL_FATOR_MODERADOR
	from TB_REGISTER_COLUMN; 
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_006_DESCR_PROFISSAO
	from TB_REGISTER_COLUMN; 
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	insert into TB_REGISTER_COLUMN(
		...
		DT_ALTERED ) values (	
		VAR_ID_REGISTER,
		'COLUMN_007_NR_MATRICULA_ESPECIAL',
		VAR_COL_VARCHAR,
		null,
		VAR_CD_ORDEM,
	...
	select max( ID ) into VAR_ID_COLUMN_007_NR_MATRICULA_ESPECIAL
	from TB_REGISTER_COLUMN; 
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	insert into TB_REGISTER_COLUMN(
		...
		DT_ALTERED ) values (	
		VAR_ID_REGISTER,
		'COLUMN_008_VL_FATOR_MODERADOR_INSS',
		VAR_COL_DOUBLE,
		null,
		VAR_CD_ORDEM,
	...
	select max( ID ) into VAR_ID_COLUMN_008_VL_FATOR_MODERADOR_INSS
	from TB_REGISTER_COLUMN; 
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_009_NR_SUBFATURA
	from TB_REGISTER_COLUMN; 
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	select max( ID ) into VAR_ID_COLUMN_010_CD_CONTRATO
	from TB_REGISTER_COLUMN; 
	set VAR_CD_ORDEM = VAR_CD_ORDEM + 1;
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		VAR_ID_COLUMN_007_NR_MATRICULA_ESPECIAL,
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		VAR_ID_COLUMN_006_DESCR_PROFISSAO,
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		VAR_ID_COLUMN_005_VL_FATOR_MODERADOR,
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		VAR_ID_COLUMN_008_VL_FATOR_MODERADOR_INSS,
	...
	insert into TB_BENEFICIARIO_COLS(
		...
		VAR_ID_COLUMN_009_NR_SUBFATURA,
