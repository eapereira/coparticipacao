...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20181128-014-dml-TECHNIT-SAUDE.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181128-015-dml-TECHNIT-SAUDE-MECSAS.sql';
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO,
		'^(180831)\\.(MECSAS)\\.([0-9]{4})([0-9]{2})\\.([0-9]{3})\\.(xlsx|XLSX)$',
