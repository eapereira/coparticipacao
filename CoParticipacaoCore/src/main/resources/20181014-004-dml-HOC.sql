...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20181014-003-dml-CARGILL.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181014-004-dml-HOC.sql';
	...
	/*********************************************************************************************************************************************/
	/*********************************************************************************************************************************************/		
	call PROC_LOG_MESSAGE('LINHA - 277');
