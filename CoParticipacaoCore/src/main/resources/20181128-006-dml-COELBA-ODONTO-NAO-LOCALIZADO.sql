...
BEGIN
	declare VAR_NM_SCRIPT_REQUIRED			varchar( 400 ) default '20181128-005-dml-COELBA-ODONTO-MECSAS2.sql';
	declare VAR_NM_SCRIPT					varchar( 400 ) default '20181128-006-dml-COELBA-ODONTO-NAO-LOCALIZADO.sql';
	...
	insert into TB_ARQUIVO_INPUT(
		...
		DT_ALTERED ) values (	
	    VAR_ID_CONTRATO,
		'^(180612)\\.(NAO-LOCALIZADO)\\.([0-9]{4})([0-9]{2})\\.([0-9]{3})\\.(xlsx|XLSX)$',
