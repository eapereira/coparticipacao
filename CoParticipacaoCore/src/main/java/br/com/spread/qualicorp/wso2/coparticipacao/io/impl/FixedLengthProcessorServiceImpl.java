 ...
 */
@Service
public class FixedLengthProcessorServiceImpl extends AbstractFileProcessorImpl
		implements FixedLengthProcessorService {
	...
	protected Map<String, Object> readLine(
		...
		try {
			...
			for (ArquivoInputColsDefUi arquivoInputColsDefUi : coParticipacaoContext
				...
				columnValue = coParticipacaoContext.getLine().substring(
						pos,
