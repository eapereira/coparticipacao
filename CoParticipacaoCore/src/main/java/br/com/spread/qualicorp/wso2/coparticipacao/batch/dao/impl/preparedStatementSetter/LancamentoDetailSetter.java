 ...
 *
 */
public class LancamentoDetailSetter extends PreparedStatementSetterAdapter<LancamentoDetailEntity> {

	private static final int COL_ID_LANCAMENTO = 1;
	...
	public LancamentoDetailSetter(SetterAdapterType setterAdapterType, LancamentoDetailEntity entity) {
	...
	private void setCommonsValues(PreparedStatement ps) throws SQLException {
		ps.setLong(COL_ID_LANCAMENTO, getEntity().getLancamento().getId());
