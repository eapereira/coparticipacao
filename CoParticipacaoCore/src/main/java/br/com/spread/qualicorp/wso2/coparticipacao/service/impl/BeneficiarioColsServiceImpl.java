 ...
 */
@Service
public class BeneficiarioColsServiceImpl extends
		AbstractServiceImpl<BeneficiarioColsUi, BeneficiarioColsEntity, BeneficiarioCols>
		implements BeneficiarioColsService {

	private static final Logger LOGGER = LogManager
			.getLogger(BeneficiarioColsServiceImpl.class);
	...
	public List<BeneficiarioColsUi> listByArquivoInputId(
