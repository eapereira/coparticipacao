...
public class CoParticipacaoReportWebServiceConfiguration extends WsConfigurerAdapter {
	private static final Logger LOGGER = LogManager.getLogger(CoParticipacaoReportWebServiceConfiguration.class);
