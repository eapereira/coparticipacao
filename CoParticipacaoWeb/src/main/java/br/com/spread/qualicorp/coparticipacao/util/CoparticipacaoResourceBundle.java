 ...
 *
 */
public class CoparticipacaoResourceBundle extends ResourceBundle {

	private static final Logger LOGGER = LogManager.getLogger(CoparticipacaoResourceBundle.class);
	
	protected static final String BUNDLE_NAME = "messages";
	protected static final String BUNDLE_EXTENSION = "properties";
	protected static final Control UTF8_CONTROL = new UTF8Control();

	public CoparticipacaoResourceBundle() {
		super();
